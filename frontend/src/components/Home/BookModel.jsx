...
const BookModel = ({ book, onClose }) => {
  return (
    ...
    onClick={onClose}>
      ...
      <p className='my-2'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur, doloribus mollitia, velit maiores molestiae, inventore nulla aliquam necessitatibus a ullam ipsa. Nesciunt minus deserunt laboriosam quos nemo, adipisci sunt ad.
      </p>
       </div>
    </div>
  );
